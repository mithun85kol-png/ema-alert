...
QUALITY_GATE_MIN_TRADING_SCORE = 9    # CHANGED (per request, 2026-08-31 — "trading score above 9 hole pathao") — was 8 (STRONG band, 8-10); now 9, so only 9.0+ fires an alert.
