...
from telegram_notifier import send_alert, send_ema_cross_report, send_breakout_alert, send_consolidation_breakout_summary, send_trendline_alert, send_opening_bias_report, send_daily_score_report, send_trading_score_summary, send_mode_failure_notice
...
def run_opening_bias_report(now_ist):
    ...
    send_opening_bias_report(bullish, bearish, no_data, now_ist, bullish_links, bearish_links)
