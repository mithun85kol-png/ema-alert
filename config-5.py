...
QUALITY_GATE_MIN_TRADING_SCORE = 8    # CHANGED (per request, 2026-08-31 — "trading score strong holei alert asbe") — was 6 (GOOD or STRONG both passed); now 8, so only the STRONG band (8-10) fires an alert. GOOD (6-7.9) signals no longer alert, though trading_score is still computed/attached either way.
